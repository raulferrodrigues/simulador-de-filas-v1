...
import { Action } from './queueSimulator/components/EventList'
...
const firstEvent = { action: Action.Enqueue, time: 2 }
const initialSize = 0
const capacity = 3
const serves = 1
const simDuration = 100

new QueueSimulator(rules, initialSize, firstEvent, capacity, serves, simDuration)
